...
def random_choice(num_choice, layers):
    ran_ch = list(np.random.randint(num_choice, size=layers))
    #print(ran_ch)
    #while ran_ch[0] == 3 or ran_ch[7] == 3 or ran_ch.count(0)>4:
    while ran_ch[0] == 3  or ran_ch.count(0)>4:
        ran_ch = list(np.random.randint(num_choice, size=layers))
    return ran_ch #list(np.random.randint(num_choice, size=layers))

def random_choice1(num_choice, layers):
    ran_ch = list(np.random.randint(num_choice, size=layers))
    #print(ran_ch)
    #while ran_ch[0] == 3 or ran_ch[7] == 3 or ran_ch.count(0)>4:
    while ran_ch[0] == 3  or ran_ch.count(3)<4 or ran_ch.count(0)>4:
        ran_ch = list(np.random.randint(num_choice, size=layers))
    for num in range(len(ran_ch)):
        if ran_ch[num] == 3:
            ran_ch.pop(num)
            ran_ch.append(3)
    return ran_ch #list(np.random.randint(num_choice, size=layers))

def random_choice2(num_choice, layers):
    ran_ch = list(np.random.randint(num_choice, size=layers))
    #print(ran_ch)
    #while ran_ch[0] == 3 or ran_ch[7] == 3 or ran_ch.count(0)>4:
    while ran_ch[0] == 3  or ran_ch.count(3)<0 or ran_ch.count(0)>4:
        ran_ch = list(np.random.randint(num_choice, size=layers))
    for num in range(len(ran_ch)):
        if ran_ch[num] == 3:
            ran_ch.pop(num)
...
def random_choice3(num_choice, layers):

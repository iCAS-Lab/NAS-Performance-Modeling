...
# Latency/Power estimation method
parser.add_argument('--use_predictive_model', default=True, action='store_true', help='Use predictive model (Random Forest) to estimate latency/power. If False, use Jetson Nano measurement.')
# parser.add_argument('--rf_model_path', type=str, default='rf_model.pkl', help='Path to trained Random Forest model for latency/power prediction')
...
parser.add_argument('--num_choices', type=int, default=37, help='number choices per layer')
# Search Settings
...
class EvolutionSearcher(object):
    ...
    def __init__(self, args):
        ...
        best_supernet_weights = './checkpoints/spos_fixed_updated_best.pth'

...
xgb1 = xgb.XGBRegressor(tree_method='exact', )
parameters = {'objective':['reg:squarederror'],
              'learning_rate': [.01, .03, 0.05],
              'max_depth': [10, 20, 30, 0],
...
mae = mean_absolute_percentage_error(y_train, y_pred_train, multioutput='raw_values')
print(f'Training Mean Absolute Percent Error: GPU Energy: {mae[0]}, Latency: {mae[1]}')
